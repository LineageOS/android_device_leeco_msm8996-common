...
public class IControl {
    ...
    /**
     * This is the package name of the QuickSet service on the LeEco LePro 3. This
     * might be different on other phones (like LG ot Honor).
     * <p>
     * Check this on the phone via "adb shell" with: > pm list packages | grep
     * quickset
     */
     ...
     * <br>
     * See also:
     * https://developer.android.com/reference/android/hardware/ConsumerIrManager.html#transmit(int,
     * int[])
     *
