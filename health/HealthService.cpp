 ...
 */
#define LOG_TAG "android.hardware.health@2.0-service.msm8996"
...
using ::device::leeco::msm8996::health::CycleCountBackupRestore;
using ::device::leeco::msm8996::health::LearnedCapacityBackupRestore;
