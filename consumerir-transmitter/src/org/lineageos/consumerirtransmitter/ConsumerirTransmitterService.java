...
=======
        Log.d(TAG, "Starting service");
>>>>>>> 6279973e... msm8996-common: socket transfer msg from IR Hal to app
        parseIRCMDIntent(intent);
>>>>>>> f0ed0c2f... msm8996-common: cache IR CMD during binding QuickSet and send again after binded
        return START_STICKY;
    }
