...
public class IControl {
   ...
   */
  public static final String QUICKSET_UEI_PACKAGE_NAME =
      "com.uei.quicksetsdk.letv";

  /**
   * This is the service class name within the Quickset Package.
   */
  public static final String QUICKSET_UEI_SERVICE_CLASS =
      "com.uei.control.Service";
   ...
   * @throws RemoteException
   */
  public int transmit(int carrierFrequency, int[] pattern)
      throws RemoteException {
    Parcel _data = Parcel.obtain();
    Parcel _reply = Parcel.obtain();
    int _result = 1;
